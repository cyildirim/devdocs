...
The [`mageUtils`](https://github.com/magento/magento2/tree/2.2/lib/web/mage/utils) helper library is also used in this example to create the new component based on `myRowTemplateConfig`.
